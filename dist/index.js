...
function useKrPhoneFormatter(initialValue = "") {
    ...
    // 포맷된 값 (input에 표시될 값)
    const [formattedValue, setFormattedValue] = react.useState(initialFormattedValue);
...
exports.formatKrPhoneNumber = formatKrPhoneNumber;
exports.useKrPhoneFormatter = useKrPhoneFormatter;
